...
function add_income_tax()
	...
	function list_salary_leave()
	{
		$html_result = $this->View->render("list_salary_leave.php");
		echo $html_result;
	}

	function list_salary_13()
	{
		$html_result = $this->View->render("list_salary_13.php");
		echo $html_result;
	}

	function add_salary_13()
	{
		$html_result = $this->View->render("add_salary_13.php");
		echo $html_result;
	}
