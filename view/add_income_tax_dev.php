...
$str_input_tt = $this->Template->load_textbox(array("name"=>"data[dc]","id"=>"dc","value"=>"","style"=>"width:100px"));	
$str_input_5 = $this->Template->load_textbox(array("name"=>"data[dc]","id"=>"dc","value"=>"","style"=>"width:100px"));
$str_input_10 = $this->Template->load_textbox(array("name"=>"data[dc]","id"=>"dc","value"=>"","style"=>"width:100px"));
$str_input_15 = $this->Template->load_textbox(array("name"=>"data[dc]","id"=>"dc","value"=>"","style"=>"width:100px"));	
$str_input_20 = $this->Template->load_textbox(array("name"=>"data[dc]","id"=>"dc","value"=>"","style"=>"width:100px"));	



$array_header_salary_product_1=  array("Stt"=>array("STT",array("style"=>"text-align:left; width:3%","rowspan"=>"3")),
	"mnv"=>array("Mã nhân viên",array("style"=>"text-align:left; width:5%","rowspan"=>"3")),
	"hoten"=>array("Họ & tên",array("style"=>"text-align:center; width:15%;white-space: nowrap","rowspan"=>"3")),						
	"ktbanthan"=>array("KT Bản thân",array("style"=>"text-align:left; width:8%","rowspan"=>"3")),
	...
	"15"=>array("" ,array("style"=>"text-align:left; width:8%")),
	"20"=>array("",array("style"=>"text-align:center; width:8%")),						
...
array(
	...
	"tongtien"=>array("Tổng Tiền Thuế TNCN Tạm Tính ",array("style"=>"text-align:left; width:8%")),
	
);

$array_header_salary_product_3=  
array(					
	"ktbanthan"=>array("ưerty",array("style"=>"text-align:left; width:8%")),
	...
	"5"=>array($str_input_5 ,array("style"=>"text-align:left; width:8%")),
	"10"=>array($str_input_5 ,array("style"=>"text-align:left; width:8%")),
	
	"15"=>array($str_input_5 ,array("style"=>"text-align:left; width:8%")),
	"20"=>array($str_input_5 ,array("style"=>"text-align:center; width:8%")),						
	"tongtien"=>array("Tổng Tiền Thuế TNCN Tạm Tính ",array("style"=>"text-align:left; width:8%")),
...
$array_salary_product=  array("Stt"=>array($i,array("style"=>"text-align:left; width:3%")),
	...
	"ngay"=>array($str_btn_chitiet,array("style"=>"text-align:left; width:5%")),
