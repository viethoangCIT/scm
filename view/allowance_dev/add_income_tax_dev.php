...
$function_title = "Nhập Thuế Thu Nhập Cá Nhân Tạm Tính";
...
$str_input_tt = $this->Template->load_textbox(array("name"=>"data[tt]","id"=>"tt","value"=>"","style"=>"width:100px; color:black;font-weight:normal;"));	
$str_input_5 = $this->Template->load_textbox(array("name"=>"data[5]","id"=>"5","value"=>"","style"=>"width:100px ; color:black;font-weight:normal;"));
$str_input_10 = $this->Template->load_textbox(array("name"=>"data[10]","id"=>"10","value"=>"","style"=>"width:100px ; color:black;font-weight:normal;"));
$str_input_15 = $this->Template->load_textbox(array("name"=>"data[15]","id"=>"15","value"=>"","style"=>"width:100px ; color:black;font-weight:normal;"));	
$str_input_20 = $this->Template->load_textbox(array("name"=>"data[20]","id"=>"20","value"=>"","style"=>"width:100px ; color:black;font-weight:normal;"));	


$array_header_income_tax_1=  array("Stt"=>array("",array("style"=>"text-align:left; width:3%","rowspan"=>"4")),
...
array("Stt"=>array("STT",array("style"=>"text-align:left; width:3%")),
	...
	"onhap"=>array($str_input_tt ,array("style"=>"text-align:center; width:8%")),						
	...
	"5"=>array($str_input_5 ,array("style"=>"text-align:left; width:3%")),
	"10"=>array($str_input_10 ,array("style"=>"text-align:left; width:3%")),
	
	"15"=>array($str_input_15 ,array("style"=>"text-align:left; width:3%")),
	"20"=>array($str_input_20 ,array("style"=>"text-align:center; width:3%")),						
...
$str_income_tax .= $this->Template->load_table_header($array_header_income_tax_2);
$str_income_tax .= $this->Template->load_table_header($array_header_income_tax_3);

	//lấy dòng nội dung table
  
for ($i=1; $i <10 ; $i++) { 
$str_input_ktbanthan = $this->Template->load_textbox(array("name"=>"data[ktbanthan]","id"=>"ktbanthan","value"=>"","style"=>"width:100px"));		
$str_input_songuoi = $this->Template->load_textbox(array("name"=>"data[songuoi]","id"=>"songuoi","value"=>"","style"=>"width:100px"));


$array_income_tax=  array("Stt"=>array($i,array("style"=>"text-align:left; width:3%")),
...
$str_save_button =  $this->Template->load_button(array("type"=>"button","onclick"=>"luu()"),"Lưu");
	$str_income_tax = $this->Template->load_form_row(array("title"=>"","input"=>$str_save_button));		
echo $str_income_tax;	
