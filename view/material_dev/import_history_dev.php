...
$function_title = "Lịch Sử Nhập Kho";
...
$str_form_material = $this->Template->load_form(array("method" => "POST", "action" => "/material/import_history"), $str_input_row);
...
if ($array_material) {
	...
	foreach ($array_material as $material) {
		...
		//tạo linh chi tiết
		$str_link_edit = $this->Template->load_link("edit", "Chi tiết", "/material/import/" . $material["id"]);
