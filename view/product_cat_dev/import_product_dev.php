...
//FUNCTION HEADER
//*****************************************
$function_title = "Import Dòng sản phẩm ";
...
$str_selectbox_manufactory = $this->Template->load_selectbox(array("name" => "id_factory", "id"=>"id_factory" ,"style" => "width:150px"), $array_factory);
$str_form_customer .= $this->Template->load_form_row(array("title" => "Nhà máy", "input" => $str_selectbox_manufactory));
...
$str_form_customer = $this->Template->load_form(array("method" => "GET", "action" => "/product_cat/import/$id_product_cat"), $str_form_customer);
