...
<?php
	...
	// LOAD FORM
	$str_form_production = $this->Template->load_form(array("method" => "GET", "id" => "form_seach", "action" => "/production/add_delivery"),$str_input_row);
	...
	if($array_delivery)
	{
		foreach($array_delivery as $delivery)
		{
			...
			$link_xoa = "/production/del_delivery/$id_delivery";
			$link_sua = "/production/add_delivery/$id_delivery?id_factory=$id_factory&id_manufactory=$id_manufactory&id_cat=$id_cat&id_product=$id_product&month=$month&id_delivery=$id_delivery";
	...
	// LOAD FORM
	$str_form_production = $this->Template->load_form(array("method" => "POST", "id" => "form_nhap", "action" => "/production/add_delivery"),$str_table_production);
