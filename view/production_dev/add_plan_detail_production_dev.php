...
<?php
	...
	$array_header_plan["col2"] = array("Máy ",array("style"=>"text-align:center; width:8%"));
	$array_header_plan["col3"] = array("Sản phẩm",array("style"=>"text-align:center; width:8%"));
	...
	$str_selectbox_product = $this->Template->load_selectbox(array("name" => "data[id_product]", "style" => "width:300px"), $array_product,$id_product);
	...
	$array_row_plan["col2"] = array("",array("style"=>"text-align:center"));
	$array_row_plan["col3"] = array($str_selectbox_product,array("style"=>"text-align:center"));
	...
	if($array_production_plan_detail)
	{
		foreach($array_production_plan_detail as $plan_detail)
		{
			...
			$array_row_plan["col2"] = array($plan_detail["machine_control"],array("style"=>"text-align:center"));
			$array_row_plan["col3"] = array($plan_detail["product"],array("style"=>"text-align:center"));
	...
	//đưa vào form
	$str_form = $this->Template->load_form(array("method"=>"POST","id"=>"form_nhap","action"=>"/production/production_plan_detail/$id_production_plan"), $str_plan.$str_hiddien_id);
