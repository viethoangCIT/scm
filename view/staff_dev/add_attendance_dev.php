...
<?php
    ...
    //ngày chấm công
    $str_input_attendance_day = $this->Template->load_textbox(array("name"=>"attendance_day","autocomplete"=>"off","value"=>"","id"=>"attendance_day"));
...
$array_work_attendance = array("1"=>"Ngày công hết hàng cho về","2"=> "Ngay công hết hàng không lương", "3" =>"Ngày nghỉ bảo hiểm hoặc bệnh", "4" =>"Ngày công lớn hơn 8 tiếng", "5" =>"Ngày công thường tính xét thưởng", "6" =>"Ngày công chủ nhật", "7" =>"Ngày nghỉ có phép", "8" =>"Ngày nghỉ vô phép", "9"=>"Ngày không bấm thẻ");
 $str_select_work_attendance = $this->Template->load_selectbox_basic(array("name"=>"work_attendance","autocomplete"=>"off","value"=>"","id"=>"work_attendance"),$array_work_attendance);
  ...
  $array_staff = array("1"=>array("code"=>"MNV0001", "name"=> "Đào Văn Tùng", "phongban"=>"BGĐ-Ban giám đốc" , "type"=>"Lao động gián tiếp"),
                       "2"=>array("code"=>"MNV0002", "name"=> "Lê Văn Nam", "phongban"=>"ISO-Quy trình", "type"=>"Lao động gián tiếp"),
                       "3"=>array("code"=>"MNV0003", "name"=> "Nguyễn Văn Hà", "phongban"=>"BGĐ-Ban giám đốc", "type"=>"Lao động trực tiếp"),
                       "4"=>array("code"=>"MNV0004", "name"=> "Đào Văn Sơn", "phongban"=>"HR-Nhân sự", "type"=>"Lao động trực tiếp"),
                       "5"=>array("code"=>"MNV0005", "name"=> "Tạ Khánh Thi", "phongban"=>"BGĐ-Ban giám đốc", "type"=>"Lao động gián tiếp"),
                       "6"=>array("code"=>"MNV0006", "name"=> "Trần Thị Sương", "phongban"=>"PRO-Sản xuất", "type"=>"Lao động trực tiếp"),
                       "7"=>array("code"=>"MNV0007", "name"=> "Vũ Văn Hà", "phongban"=>"QC-Chất lượng", "type"=>"Lao động gián tiếp"),
                       "8"=>array("code"=>"MNV0008", "name"=> "Lê Bá Anh", "phongban"=>"BGĐ-Ban giám đốc", "type"=>"Lao động trực tiếp"),
                       "9"=>array("code"=>"MNV0009", "name"=> "Hà Văn Kì", "phongban"=>"HR-Nhân sự", "type"=>"Lao động trực tiếp"),
                       "10"=>array("code"=>"MNV0010", "name"=> "Lê Thị Bích Trâm", "phongban"=>"ISO-Quy trình", "type"=>"Lao động gián tiếp"),
    );
