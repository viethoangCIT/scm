...
$array_header_salary_product=  array("Stt"=>array("Stt",array("style"=>"text-align:left; width:3%")),
	"mnv"=>array("Mã nhân viên ",array("style"=>"text-align:left; width:15%")),
	"hoten"=>array("Họ & tên",array("style"=>"text-align:center; width:8%;white-space: nowrap")),						
	"phongban"=>array("Phòng ban",array("style"=>"text-align:left; width:8%")),
	"ngay"=>array("Ngày",array("style"=>"text-align:left; width:8%")),
	"tong_lnt"=>array("Tổng lương ngày thường",array("style"=>"text-align:center; width:8%;white-space: nowrap")),						
...
$array_salary_product=  array("Stt"=>array($i,array("style"=>"text-align:left; width:3%")),
	"maso"=>array("maso".$i,array("style"=>"text-align:left; width:10%")),
	"hoten"=>array("Nguyen van ".$i,array("style"=>"text-align:center; width:8%;white-space: nowrap")),						
	"phongban"=>array("PRO-Sảnxuất",array("style"=>"text-align:left; width:8%")),
	"ngay"=>array("1/9/2017",array("style"=>"text-align:left; width:8%")),
	"tong_lnt"=>array("20000000 ".$i,array("style"=>"text-align:center; width:8%;white-space: nowrap")),						
